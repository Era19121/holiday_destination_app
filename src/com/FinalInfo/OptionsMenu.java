	...
	public void addListeners(String projectId,String userType)
	{
		...
		btnProceedToMake.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				btnViewInfomation.setEnabled(false);
				// fact table creation
				fact_dim f=new fact_dim(con);
				f.fetchInfoFromTable();
				// Dimension Table creation
				dimension d = new dimension(con);
				d.fetchInfoFromTable();
				// Linking Fact and Dimension Tables
				link lk=new link(con);
				lk.fetchInfoFromTable();
				//Dummy methods
				//data_containment dc=new data_containment(con);
				//dc.notImplementedYet();
				//Category containment
				//cat_containment ct=new cat_containment(con);
				//ct.containment();
